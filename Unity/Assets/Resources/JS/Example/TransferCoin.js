...
import { NODE_URL, FAUCET_URL } from "./Common.js";
class TransferCoin {
    async test() {
        ...
        // :!:>section_5
        let txnHash = await coinClient.transfer(alice, bob, 1000, {
        ...
        txnHash = await coinClient.transfer(alice, bob, 1000, {
            gasUnitPrice: BigInt(100)
        });
        // :!:>section_6b
        await client.waitForTransaction(txnHash, {
...
export { TransferCoin as default };

//# sourceMappingURL=TransferCoin.js.map